<div class="container" id="contactez">
  ...
  <div class="form-group row col-md-offset-3" id="form">
    <div class="col-xs-12 col-md-8">
      <input type="name" class="form-control" name="" value="Nom...">
    </div>
    <div class="col-xs-12 col-md-8">
      <input type="prenom" class="form-control" name="" value="Prénom...">
    </div>
    <div class="col-xs-12 col-md-8">
      <input type="mail" class="form-control" name="" value="Email...">
    </div>
    <div class="col-xs-12 col-md-8">
      <textarea name="name" class="form-control" rows="8" cols="80">Votre message...</textarea>
    </div>
    <div class="col-xs-12 col-md-8">
      <button type="submit" class="form-control" name="button">Envoyer</button>
    </div>
  </div>
</div>
